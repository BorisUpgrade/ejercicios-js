/*usa forof y forin para saber cuantas veces ha sido cada sonido agregado por los usuarios a favorito. 
...
for(var user of users){
    for(var key in user.favoritesSounds){
        console.log(key);
        if(!favResult.includes(key)){
            favResult.push(key);
        }
